...
public class SpawnHandler : MonoBehaviour
{
    ...
    {
        TileMapSpawner(fourOpenPillar,2500, 0.016f, 0, 250);
        TileMapSpawner(doubleRock,10000, 0.04f, 0, 250);
        TileMapSpawner(singleRock,10000, 0.03f, 0, 250);
        TileMapSpawner(greenSmallLeaf,10000, 0.03f, 0, 250);
        TileMapSpawner(bugMultyPillar,1000, 0.01f, 0, 250);
        TileMapSpawner(deadSingleTree,2500, 0.01f, 0, 250);
    }

    public void SpawnEnemies(int[,] map)
    {
        TileMapSpawner(blueSlime,200, 0.1f, 75, 175);
    }
